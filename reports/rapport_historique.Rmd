...
ggplot(top_10)+geom_col(aes(x=value/1e6, y=Origine)) + facet_wrap(.~name, scales="free_x")+ theme_minimal()+labs(title="Aéroports métropolitains", subtitle = "Top 15 des villes par leurs flux d'aviation civile en 2019, source gflowviz/DGAC.csv")+xlab("Nombre (millions)")+ylab(NULL)
```
